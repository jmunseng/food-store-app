        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            {cartItems && cartItems.length > 0 && (
              <div className="absolute -top-2 -right-3 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center">
                <p className="text-xs text-white font-semi-bold">
                  {cartItems.length}
                </p>
              </div>
            )}
          ...
          <div className="relative">
            <motion.img
              ...
              className="w-10 min-w-[40px] min-h-[10px] drop-shadow-lg rounded-full cursor-pointer"
              alt="userprofile"
              onClick={login}
            />
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 right-0 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12"
              >
                {user && user.email === "jmunseng@gmail.com" && (
                  <Link to={"/createItem"}>
